...
class WakeUpAlarmModel {
  //상대가 알람을 설정했는지 서로 알려주는 모델
  ...
  factory WakeUpAlarmModel.fromMap(Map<String, dynamic> map) {
    return WakeUpAlarmModel(
  ...
  static Future<WakeUpAlarmModel> emptyFuture() async {
    return WakeUpAlarmModel(
      wakeUpUid: "",
