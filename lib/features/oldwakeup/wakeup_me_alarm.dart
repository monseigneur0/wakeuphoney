...
import '../oldalarm/alarm2_shortcut.dart';
import '../oldalarm/alarm_edit_screen.dart';
import '../oldalarm/alarm_ring_screen.dart';
import '../oldmain/main_screen.dart';
...
class _WakeUpMeAlarmScreenState extends ConsumerState<WakeUpMeAlarmScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        centerTitle: false,
        title: (kDebugMode) ? const Text('Wake Up Me Alarm') : Text('wakeupgom'.tr()),
        actions: const [],
      ),
      body: userInfo.when(
        data: (user) {
                  ...
                  return Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const Image(
                            image: AssetImage('assets/images/aiphotos/rabbitwake.png'),
                                  ...
                                  Platform.isIOS
                                      ? showCupertinoDialog(
                                          ...
                                          builder: (context) => CupertinoAlertDialog(
                                            title: Text('alarm'.tr()),
                                            content: Text('wakeupmenotapproved'.tr()),
                                            actions: [
