...
final getMeUserModelProvider = FutureProvider.autoDispose(
    (ref) => ref.watch(mainControllerProvider.notifier).getMeUserModel());

final mainControllerProvider =
    StateNotifierProvider<MainController, bool>((ref) => MainController(
