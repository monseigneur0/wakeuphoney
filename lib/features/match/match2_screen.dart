...
class Match2Screen extends ConsumerStatefulWidget {
  static String routeName = "Match2screen";
  static String routeURL = "/match2";
  const Match2Screen({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _Match2ScreenState();
}

class _Match2ScreenState extends ConsumerState<Match2Screen> {
  var logger = Logger();
          ...
          ? Scaffold(
              ...
              body: Column(
                children: [
                  ...
                  const Center(child: Text("wow nothing"))
                ],
              ),
