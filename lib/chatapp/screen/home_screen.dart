...
import 'package:wakeuphoney/chatapp/screen/search_screen.dart';
import 'package:wakeuphoney/chatapp/widgets/widgets.dart';
...
class MyChatApp extends StatefulWidget {
  static String routeName = "mychatapp";
  static String routeURL = "/mychatapp";
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Column bodyhomeori(BuildContext context) {
    return Column(
      children: [
        const SizedBox(
          height: 200,
