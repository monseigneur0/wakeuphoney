...
class TextFormFieldWithDelete extends StatefulWidget {
  ...
  final String Function(String? errorMessage)? validatorCallback;
  ...
  @override
  TextFormFieldWithDeleteState createState() => TextFormFieldWithDeleteState();
}

class TextFormFieldWithDeleteState extends State<TextFormFieldWithDelete> {
  var error = false;
  String? errorMessage;
